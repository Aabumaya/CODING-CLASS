...
// I went back and pciked more apples
pickedApples += 10;
...
let rememberbeRouteHome = false;

console.log("Good to go home", pickedApples > 5 && rememberbeRouteHome);

let haveAMap = false;

console.log("Good to go home", rememberbeRouteHome || haveAMap || Boolean(" "));
